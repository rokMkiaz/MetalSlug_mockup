        ...
        case WM_CREATE:    
        {
            ...
            }
            {
...

                {
                    ...
                    Descriptor[0].SemanticName = "POSITION"; //VS연결
                    Descriptor[0].SemanticIndex = 0; // Semantic name 구분
                    Descriptor[0].Format = DXGI_FORMAT_R32G32_FLOAT; //넘겨주는 vertex 정보 float구성이니 4x8
                    Descriptor[0].InputSlot = 0;        //연결되는 슬롯 정보
                    Descriptor[0].AlignedByteOffset = 0;//몇 바이트를 넘어야 나오는가
                    Descriptor[0].InputSlotClass = D3D11_INPUT_PER_VERTEX_DATA;
                    Descriptor[0].InstanceDataStepRate = 0;//인스턴스 관련된 내용인가
                    ...
                    Descriptor[1].AlignedByteOffset = 0;//D3D11_APPEND_ALIGNED_ELEMENT; 앞부분 후 부분부터 읽게됨
